  ...
  var merge = function merge() {
    ...
    args.forEach(function (prop) {
      Object.keys(prop || {}).forEach(function (propName) {
        ...
        if (
          type(propValue) === "Object" &&
          type(results[propName]) === "Object"
        ) {
    ...
    _createClass(Widget, [
      ...
      },
      {
        ...
        value: function buildWidget() {
          ...
          if (this.props.prebuilt) {
            ...
            widgetEl = parentEl.querySelector(
          ...
          parentEl.classList.add(
            this.props.classNames.base + "--" + this.direction
          );
        ...
        value: function changeIndexTo(index, force) {
          ...
          if (this.indexActive !== index || force) {
            [].forEach.call(this.widgetEl.children, function (el, i) {
              ...
              addRemoveClass(
                el,
                i === _this2.indexSelected,
                _this2.props.classNames.selected
              );
            });
            ...
            if (this.props.tooltip) {
              ...
              var label =
                index < 0
                  ? this.props.tooltip
                  : (_this$values$index = this.values[index]) === null ||
                    _this$values$index === void 0
                  ? void 0
                  : _this$values$index.text;
      ...
      },
      {
        ...
        value: function destroy() {
          ...
          if (parentEl.classList.contains(this.props.classNames.base)) {
            if (this.props.prebuilt) {
              this.widgetEl = parentEl.querySelector(
                "." + this.props.classNames.base + "--stars"
              );
      ...
      },
      {
        ...
        value: function eventListener(el, action, events, items) {
          ...
          events.forEach(function (ev) {
            return el[action + "EventListener"](
              ev,
              _this3.events[ev],
              items || false
            );
      ...
      },
      {
        ...
        value: function indexFromEvent(ev) {
          ...
          var origin =
            ((_ev$touches = ev.touches) === null || _ev$touches === void 0
              ? void 0
              : _ev$touches[0]) ||
            ((_ev$changedTouches = ev.changedTouches) === null ||
            _ev$changedTouches === void 0
              ? void 0
              : _ev$changedTouches[0]) ||
            ev;
      ...
      },
      {
        ...
        value: function onKeyDown(ev) {
          ...
          var minIndex = -1;
          var index = Math.min(
            Math.max(this.selected() + increment, minIndex),
            maxIndex
          );
      ...
      },
      {
        ...
        value: function onReset() {
          ...
          var index = this.valueIndex(
            (_this$el$querySelecto = this.el.querySelector("[selected]")) ===
              null || _this$el$querySelecto === void 0
              ? void 0
              : _this$el$querySelecto.value
          );
      ...
      },
      {
        ...
        value: function selectValue(index, triggerChangeEvent) {
          ...
          // (int, bool):void
          this.el.value =
            ((_this$values$index2 = this.values[index]) === null ||
            _this$values$index2 === void 0
              ? void 0
              : _this$values$index2.value) || ""; // first set the new value
        ...
        value: function build() {
          ...
          this.queryElements(this.selector).forEach(function (el) {
            ...
            if ("SELECT" === el.tagName && !el.widget) {
              ...
              if (
                !options.prebuilt &&
                el.parentNode.classList.contains(options.classNames.base)
              ) {
                _this.unwrap(el);
              }
...
/**
 * Customized for LearnHub
 */
document.addEventListener("DOMContentLoaded", function () {
  new StarRating(".star-rating", { tooltip: false });
});
